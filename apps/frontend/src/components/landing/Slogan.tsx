...
export default function Slogan() {
  return (
    <div className="relative h-[450px] sm:h-[700px]">
      ...
      />
      <div className="flex flex-col items-center absolute top-0 left-0 w-full h-full bg-black/60">
        <Cabecalho />
        <div className="flex flex-col justify-center items-center flex-1 gap-5">
          ...
          <Link
            href="/agendamento"
            className="
                bg-gradient-to-r from-green-500 to bg-green-600 text-white font-semibold 
                text-base md:text-lg px-4 py-2 rounded-sm hover:from-green-600 to hover:bg-green-700"
          >
            Agendar Agora
          </Link>
        </div>
